...
export default function Announce() {
    ...
    return (
        <>
            <a className="menu-link" data-bs-toggle="modal" data-bs-target="#exampleModalAnnounce">
                <FontAwesomeIcon className="text-2xl text-white" icon="fa-solid fa-comment-medical" />
            </a>

            <div className="modal fade z-50" id="exampleModalAnnounce" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
